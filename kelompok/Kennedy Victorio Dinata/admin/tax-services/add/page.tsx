...
export default function AddTaxServicePage() {
  ...
  const addMutation = useMutation({
    mutationFn: () =>
      apiRouter.taxServices.addTaxService({
        name,
        description,
        status,
        icon,
    ...
    onSuccess: () => {
      alert("Tax Service berhasil ditambahkan!");
    ...
    onError: (error: any) => {
      console.error(error);
      alert("Gagal menambahkan Tax Service.");
    },
  });
      ...
      <div className="mx-auto mt-16 max-w-3xl">
        ...
        <div className="rounded-3xl bg-white p-8 shadow">
          ...
          <p className="mt-2 text-slate-500">
            Tambahkan layanan perpajakan baru.
          </p>
